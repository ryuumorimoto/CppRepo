...
int main(int argc, char* argv[]) {
    ...
    // output
    cout << argv[1] << " processed" << endl;
    cout << "card num is " << card.size() << endl;
    int ans = getIncludedCard(card.data(), card.size());
    if (ans) {
        cout << "All included" << endl;
    } else {
        cout << "not All included" << endl;
    }
